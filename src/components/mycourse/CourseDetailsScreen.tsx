...
import CourseDetailsReviewTab from "../course-details/CourseDetailsReviewTab";
...
const CourseDetailsScreenMySource: React.FC<CourseDetailsScreenProps> = ({
  route,
  navigation,
}) => {
...
export default CourseDetailsScreenMySource;
